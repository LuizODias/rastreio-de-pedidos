...
module.exports = {
            ...
            use: [
              {
                ...
                options: {
                  // disable interfacechecker - we will use it in fork plugin
                  transpileOnly: true,
                },
              },
            ],
  ...
  plugins: [
    ...
    // Watcher doesn't work well if you misinterfacecasing in a path so we use
    ...
    // Perform interfacechecking and linting in a separate process to speed up compilation
